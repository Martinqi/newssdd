    ...
    <div class="mui-inner-wrap">
        ...
        <header  class="mui-bar mui-bar-nav">
            ...
            if(isset($_SESSION["memberlogin"])) {
                ?>
                <a style="float: right;margin-top: 12px" href="index/list.php">欢迎 <?php echo $_SESSION["name"]?></a>
                <?php
            }else {
                ?>
                <a  class="mui-icon mui-icon-contact mui-pull-right" href="index/admin.php"></a>
                <?php
            }
            ?>
        </header>
                ...
                <div class="mui-slider">
                    <div class="mui-slider-group mui-slider-loop">
                        ...
                        <div class="mui-slider-item mui-slider-item-duplicate">
                            <a href="index/show.php?id=<?php echo $row['id']?>">
